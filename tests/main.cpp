...
int main(int argc, char* argv[]) {
    ...
    const std::vector<TestCase> tests = {
        ...
        {"UpdaterDirectCallbacksAreExceptionSafeAndReentrant", testUpdaterDirectCallbacksAreExceptionSafeAndReentrant},
        ...
        {"UpdaterHealthyMarkRequiresMatchingTerminalReceipt", testUpdaterHealthyMarkRequiresMatchingTerminalReceipt},
        {"UpdaterConfirmsLegacyPendingFromTerminalSnapshot", testUpdaterConfirmsLegacyPendingFromTerminalSnapshot},
        {"UpdaterScopesCustomStagingByManifest", testUpdaterScopesCustomStagingByManifest},
        {"UpdaterHealthConfirmationDeadlineAndRetention", testUpdaterHealthConfirmationDeadlineAndRetention},
        {"UpdaterReconcilesCompletedRollbackPendingState", testUpdaterReconcilesCompletedRollbackPendingState},
        ...
        {"UpdaterFailsClosedWhenAcceptedStateIsUnreadable", testUpdaterFailsClosedWhenAcceptedStateIsUnreadable},
        {"FuzzSmokeParsersAndPaths", testFuzzSmokeParsersAndPaths},
        {"SecurityBoundaryRegressions", testSecurityBoundaryRegressions},
        {"ApplyExecutorHandlesInjectedFilesystemFaultMatrix", testApplyExecutorHandlesInjectedFilesystemFaultMatrix},
        ...
        {"DefaultNetworkAdapterUsesLoopbackTransportContract", testDefaultNetworkAdapterUsesLoopbackTransportContract},
        {"DefaultNetworkAdapterHonorsTimeoutAndCancellation", testDefaultNetworkAdapterHonorsTimeoutAndCancellation},
        {"PlatformProcessAdapterLaunchesAndWaitsNatively", testPlatformProcessAdapterLaunchesAndWaitsNatively},
    };
